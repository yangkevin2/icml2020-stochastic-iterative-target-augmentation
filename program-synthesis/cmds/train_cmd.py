...
train_seq2seq_model(args.signal, args.nb_ios, args.nb_epochs, args.nb_st_epochs, args.k, args.self_train_max_attempts, args.optim_alg,
                    ...
                    args.use_cuda, args.log_frequency, args.self_train_use_beam, args.epochs_per_dataset, args.self_train_only_new_samples, args.chunk_dir, args.small_epochs_per_full)
